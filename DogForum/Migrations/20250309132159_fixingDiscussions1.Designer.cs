...
namespace DogForum.Migrations
{
    ...
    [Migration("20250309132159_fixingDiscussions1")]
    partial class fixingDiscussions1
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DogForum.Data.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("DogForum.Models.Comments", b =>
                {
                    ...
                    b.HasOne("DogForum.Data.ApplicationUser", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("DogForum.Data.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
